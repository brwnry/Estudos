...
del lista[2]  # Removendo o elemento na posição 2 da lista. Não é interessante para listas grandes porque o Python realoca todos os elementos para ocupar a posição que foi deletada causando lentidão de memória.
...
lista = ['Egg', 'Bacon', 'Spam', 'Spam', 'Spam', 'Sausage', 'Spam', 'Cheese', 'Ham']  # Lista do menu do dia.
print(lista.count('Spam'))  # Contando quantas vezes o elemento Spam aparece na lista.
...
print(lista_a)  # lista_a = [94, 41, 57, 49, 99, 32, 12, 1, 0, -1, -2, -3, -4, -5, -6]
