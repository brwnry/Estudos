...
try:  # tente:
  num = int(
      input('Digite um número inteiro: '))  # Digite um número inteiro: 10
...
try:  # tente:
  ...
  elif len(nome) >= 5 and len(
      nome
  ) <= 6:  # Se o tamanho do nome for maior ou igual a 5 e menor ou igual a 6,
...
nome = input(
    "Digite o seu primeiro nome: ")  # Digite o seu primeiro nome: Marcos
